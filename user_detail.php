...
?>
  ...
  <table cellspacing="0" border="0" width="100%" cellpadding="0">
    <tr>
      <td colspan="2" valign="bottom" align="left" width="100%" colspan="2"><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=basic"?>"><img alt="/ User Data \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=personal"?>"><img alt="/ Personal Details \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=email"?>"><img alt="/ Registred Addresses \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=status"?>"><img alt="/ Account Status \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><br><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=delivery"?>"><img alt="/ Delivery Mode \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=delivery_advanced"?>"><img alt="/ Advanced Delivery Properties \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=mailbox"?>"><img alt="/ Mailbox properties \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><br><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=forwards_from"?>"><img alt="/ Forwarders from other accounts \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=forwards_to"?>"><img alt="/ Forwarding to other account \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=access"?>"><img alt="/ User Access \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><?php if(!$SINGLE_USER) { ?><br><a href="<?=$PHP_SELF."?rootdn=$rootdn&domain=$domain&user=$user&view=actions"?>"><img alt="/ Actions \" vspace="0" hspace="0" border="0" src="images/xxx.png"></a><?php } ?></td>
  </tr>
</table>
