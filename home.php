<?php
// start page
// $Id: home.php,v 1.1 2002-12-11 15:09:23 turbo Exp $
//
require("pql.inc");
?>
<html>
...
?>
<span class="title1"><?php echo PQL_WELCOME ?> phpQLAdmin <?php echo PQL_VERSION ?></span>
<br>
<?php echo PQL_DESCRIPTION ?><br>
<ul>
	<li><form action="domain_add.php" method="post"><?php echo PQL_DOMAIN_ADD; ?><br><input type="text" name="domain" value="<?php echo $domain; ?>"><input type="submit" value="<?php echo PQL_ADD; ?>"></form><br></li>
	<!-- begin search engine snippet -->
	<li>
	<form method=post action="search.php">
      	<?php echo PQL_SEARCH_TITLE; ?><br>
